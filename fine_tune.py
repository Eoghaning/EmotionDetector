"""
SAFE FINE-TUNING SCRIPT - 59.12% → 62%
Ultra-conservative approach with very low learning rate
"""
import torch
...
def main():
    ...
    BATCH_SIZE = 64
    EPOCHS = 40
    LEARNING_RATE = 0.000035  # Extremely low learning rate
    NUM_CLASSES = 7
    VAL_SPLIT = 0.2
    EARLY_STOPPING_PATIENCE = 12
    
    # Moderate augmentation (preserve learned features)
